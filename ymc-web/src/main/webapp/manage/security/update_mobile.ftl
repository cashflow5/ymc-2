...
<div class="normal_box">
		...
		<h1 class="modify-title">修改绑定手机</h1>
                    ...
                    <div class="form-box">
                        ...
                        <div class="btn-box"><a href="javascript:void(0);" 
                        onclick="nextUpdate('${BasePath}/merchants/security/updateMobilePre.sc','${BasePath}/merchants/security/updateMobileNext.sc');" class="btn-blue-1 medium">下一步</a></div>
                    </div>
