...
<#-- submitUrl: 表单提交url -->
<#-- importJs: 额外导入的js -->
<#macro add_update_commodity_common 
	pageTitle=""
	submitUrl=""
	importJs=""
	 >
...
<style>
	.quick-btns{position:fixed;top:160px;width:967px;padding:5px;text-align:right;background:#FFFFFF;z-index:2}
	...
	<div class="tab_panel" id="query_goods_tab_panel">
		...
		<div class="tab_content" style="margin-top:50px;">
			...
			<div class="detail_item_layer" id="goods_cat_layer">
				...
				<div class="detail_item_content">
					<select name="rootCattegory" class="fl-lf" id="category1">
					    <option value="" selected="selected">一级分类</option>
					</select>
                    <select name="secondCategory" class="fl-lf" id="category2">
                    	<option value="" selected="selected">二级分类</option>
                    </select>
                    <select name="threeCategory" class="fl-lf" id="category3">
		  ...
		  <div class="detail_item_layer">
				<label class="detail_item_label">商品卖点： <span class="detail_item_star">&nbsp;</span> </label>
				<div class="detail_item_content">
			...
			<div class="detail_item_layer">
				...
				<div class="detail_item_content">
					<input type="text" class="inputtxt" id="goods_supplierCode" name="supplierCode" maxlength="20" value=""/>
			...
			<div class="detail_item_layer">
				<label class="detail_item_label">市场价格： <span class="detail_item_star">*</span></label>
				<div class="detail_item_content">
			...
			<div class="detail_item_layer">
				<label class="detail_item_label">商品图片： <span class="detail_item_star">*</span></label>
				<div class="detail_item_content">
					...
					<div id="goods_commodityImage_tip">
						需上传7张（服装类可上传5）商品图片，图片格式为jpg，尺寸为800*800至1000*1000之间的<strong>正方形</strong>图片，大小不超过500KB。
					</div>
				</div>
				<div style="height: 1px; clear: both;"></div>
			</div>
			...
			<div class="detail_item_layer">
				<label class="detail_item_label">商品描述： <span class="detail_item_star">*</span></label>
				<div class="detail_item_content">
			...
			<div class="detail_submit_layer">				
				<a class="button" id="commodity_save" style="margin-left:4px;" onclick="goodsAdd.submit.submitForm(false)" ><span>保存</span></a>
				<a class="button" id="commodity_audit" onclick="goodsAdd.submit.submitForm(true)" ><span>保存并提交审核</span></a>
				<a class="button" id="commodity_pre" onclick="goodsAdd.submit.preview()" ><span>预览</span></a>
...
<script type="text/javascript" src="${BasePath}/yougou/js/manage/commodity/addOrUpdateCommodity.js?${style_v}"></script>
${importJs}
</body>
</html>
