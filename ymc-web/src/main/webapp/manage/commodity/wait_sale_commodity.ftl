...
<body>
	<div class="main_container">
		<div class="normal_box">
			...
			<div class="tab_panel">
				<ul class="tab">
					<li class="curr"><span>待售商品</span></li>
					<li onclick="javascript:location.href='${BasePath}/commodity/goWaitSaleSensitiveCommodity.sc'"><span>含敏感词</span></li>
					...
					<li class="tab_fr" style="right:100px;" title="可根据搜索条件导出">
						<a class="button" href="javascript:void(0);" onclick="doExport();">
							<span> 导出</span>
						</a>
					...
					<div class="search_box">
						<form id="queryForm" name="queryForm" method="post">
							...
							<p>
								...
								<span style="padding-left:62px;"><a id="mySubmit" class="button" onclick="javascript:qc.formSubmit('/commodity/goWaitSaleCommodity.sc');"><span>搜索</span></a></span>
							</p>
						</form>
					</div>
					<!--搜索end-->
				    ...
				    <table class="common_lsttbl mt10">
                            	...
                            	<tr class="cz_box">
                                	...
                                	.common_lsttbl_cz .cz_bd_1 a{margin-left:8px;}
                                    	...
                                    	<div class="cz_bd cz_bd_1 fl">
                                            ...
                                            <a href="javascript:;" onclick="javascript:qc.opt.deleteBatch_OnClick('/commodity/goWaitSaleCommodity.sc');return false;">删除</a>
                                            
                                            <input type="checkbox" class="checkall ml8" id="checkAll_submitAudit">
                                            <a href="javascript:;" onclick="javascript:qc.opt.submitAuditBatch_OnClick('/commodity/goWaitSaleCommodity.sc');return false;">提交审核</a>
                                        </div>
							...
							<#list pageFinder.data as item>
                                ...
                                <tr class="proitm_bd" id="${item.commodity_no!""}-3">
                                    ...
                                    <td><strong class="c3">0</strong></td>
                                    <td>${item.create_date!"—"}</td>
                                    <td>${item.submit_audit_date!"—"}</td>
                                    ...
                                    <td class="td_brdrrt">
										...
										<p><a href="javascript:void(0);" id="n_${(item.commodity_no)!''}" onclick="checkStatus('${(item.commodity_no)!''}');">修改</a></p>
										<!--新建-->
