...
<script type="text/javascript">
  ...
  function formSubmit(){
	  	$.ajax({ 
			type: "post", 
			url: "${BasePath}/taobao/updateTaobaoShop.sc", 
...
<body>
	<div class="form_container">
		<form id="newShopForm" name="newShopForm" action="${BasePath}/taobao/updateTaobaoShop.sc" method="post">
		<table class="form_table">
			<tbody>
				<tr>
					<th><span class="star">*</span>淘宝店铺名称：</th>
					<td><input type="text" id="taobaoShopName" name="taobaoShopName"  class="ginput" value="${taobaoShop.taobaoShopName!''}" style="width:180px;"/>
					&nbsp;&nbsp;<span style="color:red;" id="taobaoShopNameError"></span>
					</td>
				</tr>
				<tr>
					<th><span class="star">*</span>店铺主账号：</th>
					<td><input type="text" id="nickName" name="nickName"  class="ginput"  value="${taobaoShop.nickName!''}" style="width:180px;"/>
				...
				<tr>
					...
					<td>
					<input type="text" id="taobaoShopUrl" name="taobaoShopUrl"  class="ginput" value="${taobaoShop.taobaoShopUrl!''}" style="width:280px;"/>
					&nbsp;&nbsp;<span style="color:red;" id="taobaoShopUrlError"></span>
					</td>
				</tr>
				<tr>
					<th><input type="hidden" id="id" name="id" value="${taobaoShop.id!''}"/></th>
