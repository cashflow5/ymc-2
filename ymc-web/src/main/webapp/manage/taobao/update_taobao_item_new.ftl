...
<head>
    ...
    <script type="text/javascript">
		...
		goodsAdd.url.submitUrl = basePath + "/taobao/updateTaobaoItem.sc?isPreview=0";
...
<body>
    ...
    <div id="content" class="wrap clearfix">
        ...
        <div id="right" class="fl">
            <div class="fix_title">
                <span><a onclick="javascript:goodsAdd.saveTemplate()" href="javascript:void(0);">保存属性模板</a></span>
            ...
            <input type="text" name="threeCategory" class="commodity_text" id="threeCategory"  value="${commodity.catStructName}"/>
            <input type="text" name="numIid" class="commodity_text" id="numIid"  value="${numIid}"/>
            <input type="text" name="extendId" class="commodity_text" id="extendId"  value="${extendId}"/>
            <input type="text" name="title" class="commodity_text" id="title"  value="${commodity.commodityName}"/>
            ...
            <dl class="basic_information basic-pd5 clearfix" id="catedl">
                ...
                <dd><span class="btn btn_gary2" id="reSel">编辑分类</span></dd>
            </dl>
            <dl class="basic_information basic-pd5 clearfix">
            ...
            <dl class="basic_information clearfix">
                ...
                <dd>
                    <input type="text" name="yougouStyleNo" class="commodity_text" id="commodity_style" />
            ...
            <dl class="basic_information clearfix isSizePrice">
                ...
                <dd>
                    <input type="text" name="yougouSupplierCode" class="commodity_text" id="commodity_code" />
            ...
            <dl class="basic_information clearfix isSizePrice">
                ...
                <dd>
                    <input type="text" name="yougouPrice" class="commodity_text" id="commodity_price" />
            ...
            <dl class="basic_information clearfix isSizePrice">
                ...
                <dd>
                    <input type="text" name="price" class="commodity_text" id="commodity_market_value" />
            ...
            <!-- 尺码 -->
            <dl class="basic_information clearfix">
                <dt class="v_title"><em>*</em>尺码：<p class="check-tip cred ml13 none" id="sizeNo_tip"></p></dt>
                <dd>
            ...
            <dl class="basic_information clearfix">
                <dt class="v_title"><em>*</em>商品描述：<p class="check-tip cred ml13 none" id="goods_prodDesc_tip"></p></dt>
                <dd>
    ...
    <script type="text/javascript" src="${BasePath}/yougou/js/calendar/lhgcalendar.js?${style_v}"></script>
    ...
    <script type="text/javascript" src="${BasePath}/yougou/js/manage/taobao/updatetaobaoitem.js?${style_v}"></script>
    ...
    <script type="text/javascript" src="${BasePath}/yougou/js/manage/taobao/business-center.js?${style_v}"></script>
    ${importJs}
</body>
</html> 
</#macro>	