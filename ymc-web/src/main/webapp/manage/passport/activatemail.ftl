...
<div class="wrap mt25">
    您当前所在位置 &gt; 商家中心 &gt;
    <span class="cblue">激活邮箱</span>
</div>
<div class="wrap" style="width:550px;">
    <div class="<#if isScuess?? && isScuess==true>fdpwd_suc<#else>fdpwd_fail</#if>">
    	 <div class="con">
       	  <h2>${message}</h2>
          <p class="mt20">您可立即返回 <a href="${BasePath}/merchants/login/to_index.sc" class="cblue">商家中心首页</a></p>
          <p class="c9 mt5"><span id="time">5</span>秒后，页面自动跳转到商家中心首页</p>
         </div>
    </div>
</div>
