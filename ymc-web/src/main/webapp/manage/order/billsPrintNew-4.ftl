			...
			<p style="position:absolute;top:0;right:0;"><span class="fl icon_info"></span><span class="fl ml5" style="color:#999;">默认显示30天的订单，可设置条件查询更多订单，缺货订单请不要发货</span></p>
			    <!-- 单据打印导航tab模版引入 -->
			     <ul class="tab">
					...
					<li onclick="location.href='${BasePath}/order/toPrintNewOutstock.sc'" class="curr"  ><span>缺货订单</span></li>
					<li onclick="location.href='${BasePath}/order/toPrintNewAll.sc'" > <span>全部</span></li>
				</ul>
				<div class="tab_content"> 
					<!--搜索start-->
					<div class="search_box">
						<form action="toPrintNewOutstock.sc" id="queryVoform" name="queryVoform" method="post">
							<!--是否一单一货-->
									...
									<td colspan="17" style="padding:0;text-align:left;">
										<div class="tb_dobox">
											<div class="dobox">
												...
												<a href="javascript:;" onclick="order.print.doExportOutStockOrder()">导出缺货订单</a> 
												&nbsp;&nbsp;&nbsp;
											</div>
											<div class="page"> 
												<#if pageFinder ??>
							...
							<#if pageFinder??&&pageFinder.data??>
								<#list pageFinder.data as item>
									...
									<tr>
										...
										<td style="width:60px;"><#if item.backorderDate??>${item.backorderDate?string("yyyy-MM-dd HH:mm:ss")}</#if></td>
