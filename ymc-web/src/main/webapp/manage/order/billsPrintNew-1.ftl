	...
	<div class="main_container">
		<div class="normal_box">
			...
			<p style="position:absolute;top:0;right:0;"><span class="fl icon_info"></span><span class="fl ml5" style="color:#999;">默认显示30天的订单，可设置条件查询更多订单，缺货订单请不要发货</span></p>
				<ul class="tab">
					<li onclick="location.href='${BasePath}/order/toDocumentPrintingNew.sc'" class="curr" ><span>未打印</span></li>
				...
				<div class="tab_content"> 
					...
					<div class="search_box">
						<form action="toDocumentPrintingNew.sc" id="queryVoform" name="queryVoform" method="post">
							<!--是否一单一货-->
									...
									<td colspan="17" style="padding:0;text-align:left;">
										<div class="tb_dobox">
											<div class="dobox">
												...
												<a href="javascript:;" onclick="order.print.doExportOrder('/order/toDocumentPrintingNew.sc')">导出拣货清单</a> 
