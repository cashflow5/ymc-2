		...
		<div class="normal_box">
			...
			<p style="position:absolute;top:0;right:0;"><span class="fl icon_info"></span><span class="fl ml5" style="color:#999;">默认显示30天的订单，可设置条件查询更多订单，缺货订单请不要发货</span></p>
			     <ul class="tab">
					...
					<li onclick="location.href='${BasePath}/order/toPrintDelivery.sc'"  class="curr" ><span>已发货</span></li>
				...
				<div class="tab_content"> 
					...
					<div class="search_box">
						<form action="toPrintDelivery.sc" id="queryVoform" name="queryVoform" method="post">
							<!--是否一单一货-->
