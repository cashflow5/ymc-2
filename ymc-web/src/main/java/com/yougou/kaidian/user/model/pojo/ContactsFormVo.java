...
public class ContactsFormVo implements Serializable {
	...
	public void initFormVoByContactList(){
		...
		if( null!=contactList && 0<contactList.size() ){
			...
			for(int i=0;i<size;i++){
				...
				switch (type){
					case UserConstant.CONTACT_TYPE_CHIEF :
						...
						break;
					case UserConstant.CONTACT_TYPE_BUSINESS :
						...
						break;
					case UserConstant.CONTACT_TYPE_AFTERSALE :
						...
						break;
					case UserConstant.CONTACT_TYPE_FINANCE :
	...
	public List<SupplierContact> generateContactVoList(){
		...
		chiefVo.setType( UserConstant.CONTACT_TYPE_CHIEF );
		...
		if(StringUtils.isNotBlank(businessContact)){
			...
			businessVo.setType( UserConstant.CONTACT_TYPE_BUSINESS );
		...
		if(StringUtils.isNotBlank(afterSaleContact)){
			...
			afterSaleVo.setType( UserConstant.CONTACT_TYPE_AFTERSALE );
		...
		if(StringUtils.isNotBlank(financeContact)){
			...
			financeVo.setType( UserConstant.CONTACT_TYPE_FINANCE );
		...
		if(StringUtils.isNotBlank(techContact)){
			...
			techVo.setType( UserConstant.CONTACT_TYPE_TECH );
