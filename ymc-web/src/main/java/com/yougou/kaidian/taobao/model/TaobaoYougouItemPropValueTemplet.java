 ...
 */
public class TaobaoYougouItemPropValueTemplet implements Serializable {
	...
	public String getTaobaoVName() {
		return taobaoVName;
	}
	public void setTaobaoVName(String taobaoVName) {
		this.taobaoVName = taobaoVName;
	}
