...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            // runtimeOrder: 'flash',
           // sendAsBinary: true,
            server: basePath+'/img/uploaddesc.sc',
        ...
        function addFile( file ) {
            ...
            var $li = $( '<li id="' + file.id + '" num="'+index+'">' +
        ...
        uploader.on( 'uploadSuccess', function( file,response) {
        	...
        	if(response.success==true){
            	...
            	if (response.message == '1') {
            		...
            		errorText =errorText+file.name+',商品图片大小超过了 500 KB!<br>';
            	}else if (response.message == '4') {
            		//ygdg.dialog.alert(file.name+',商品图片分辨率不符合  740-790px * 740-790px的规格');
            		errorText =errorText+file.name+',商品图片分辨率不符合  740-790px * 740-790px的规格<br>';
