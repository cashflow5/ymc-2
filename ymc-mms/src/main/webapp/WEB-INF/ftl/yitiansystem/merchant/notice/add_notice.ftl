...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr">
				  <span><a href="#" class="btn-onselc">添加公告</a></span>
				</li>
				
			</ul>
		</div>
 <div class="modify"> 
     <form action="${BasePath}/yitiansystem/notice/add_notice.sc" name="noticeFrom" id="noticeFrom" method="post"> 
                        ...
                        <tr>
	                        ...
	                        <td style="text-align:left;">
		                         ...
		                         <select name="merchantType" id="merchantType">
		                           ...
		                           <option value="1">入优购仓库，优购发货</option>
		                           <option value="2">不入优购仓库，优购发货</option>
		                           <option value="0">不入优购仓库，商家发货</option>
		                         </select>
	                        </td>
	                        <td style="text-align:left;">
	                             <input id="isTop" type="checkbox" value="1" name="isTop">
	                         	 <label>置顶</label>
	                         	 <input id="isRed" type="checkbox" value="1" name="isRed">
	                         	 <label>高亮</label>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td style="text-align:left;"  colspan=3>
								 ...
								 <input id="title" type="text" name="title" style="width:400px;" maxlength="40" title='限制40个字符'>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td style="text-align:left;" colspan=3>
	                         	 <label><span style="color:red;">&nbsp;*</span>内容：</label>
	                         	 <textarea id="no_content" name="content" style="width:100%;height:465px;"></textarea>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td style="text-align:center;" colspan=3>
								<input id="btn" type="button" value="提交" class="yt-seach-btn" onclick="return addNotice();">
	                        </td>
	                    </tr>
                </table>
       	</form>
