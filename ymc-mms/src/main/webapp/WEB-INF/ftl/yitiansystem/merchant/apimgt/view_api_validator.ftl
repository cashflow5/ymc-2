...
<div class="container">
	...
	<div class="toolbar">
		<div class="t-content">
			<div class="btn" onclick="javascript:openwindow('${BasePath}/openapimgt/api/inputparam/metadata/view.sc?refId=${api.id?default('')}',　800,　500,　'添加API输入参数验证器')">
				<span class="btn_l"></span><b class="ico_btn add"></b><span class="btn_txt">添加API输入参数验证器</span><span class="btn_r"></span> </div>
		</div>
	</div>
	<!--工具栏end-->
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				...
				<li class="curr">
				  <span><a href="#" class="btn-onselc">API验证器链</a></span>
				</li>
				<li>
				...
				<tbody>
                    <#if api.apiInputParams?? && api.apiInputParams?size != 0>
						<#list api.apiInputParams as apiInputParam>
							<#if apiInputParam.apiInputParamMetadatas?? && apiInputParam.apiInputParamMetadatas?size != 0>
								<#list apiInputParam.apiInputParamMetadatas as apiInputParamMetadata>
									<tr>
										...
										<td>
											<a href="javascript:void(0);" onclick="openwindow('${BasePath}/openapimgt/api/inputparam/metadata/view.sc?metadataId=${apiInputParamMetadata.id}&refId=${api.id?default('')}',　800,　500,　'修改API输入参数验证器')">修改</a>
...
function deleteApiInputParamMetadata(id) {
	if (confirm('确定删除该API验证器链?')) {
		$.ajax({ type : 'post', url: '${BasePath}/openapimgt/api/inputparam/metadata/delete.sc', dataType: 'text', data: 'id=' + id,
