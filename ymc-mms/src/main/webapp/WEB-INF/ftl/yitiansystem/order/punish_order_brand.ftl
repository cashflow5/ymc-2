...
<div class="container">
	...
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li>
				  <span><a href="${BasePath}/yitiansystem/merchant/order/punishOrder_merchant.sc" class="btn-onselc">商家缺货统计</a></span>
				</li>
				<li class="curr">
				  <span>品牌缺货统计</span>
   ...
   <div class="modify"> 
     <form action="${BasePath}/yitiansystem/merchant/order/punishOrder_brand.sc" name="queryForm" id="queryForm" method="post">
  			  	<div class="wms-top">
                     <label>商家名称：</label>
                ...
                <table cellpadding="0" cellspacing="0" class="list_table">
                        ...
                        <tr>
	                        ...
	                        <th style="width:80px;">实际发货件数</th>
	                        <th style="width:80px;">缺货件数</th>
                        ...
                        <tbody>
                        	<#if pageFinder??&&pageFinder.data??>
	                         ...
	                         <tr>
		                        ...
		                        <td><a href="javascript:doExport('${(item.merchantCode)!'' }','${params.stockoutDateStart!''}','${params.stockoutDateEnd!''}','${(item.brandName)!'' }')">导出商品缺货明细</a></td>
	                        </tr>
	                        </#list>
	                        </#if>
                      </tbody>
...
// 导出数 据
function doExport(merchantCode,stockoutDateStart,stockoutDateEnd,brandName) {
    var params="?merchantCode="+merchantCode+"&stockoutDateStart="+stockoutDateStart+"&stockoutDateEnd="+stockoutDateEnd+"&brandName="+brandName;
