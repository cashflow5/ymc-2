...
<div class="container">
 ...
 <div class="modify"> 
               <form action="${BasePath}/yitiansystem/merchants/businessorder/add_merchants_role.sc" name="queryForm" id="queryForm" method="post" style="padding:0px;margin:0px;">
		      		 <table cellpadding="0" cellspacing="0" class="list_table">
                        ...
                        <tr><td>备注：</td>
                        <td><textarea name="remark" id="remark" cols=60"/></textarea>
                        </td></tr>
                        <tr><td width="100px">
                            <label><span style="color:red;"></span>分配权限：</label>
                          </td><td><div class="content_wrap"><ul id="ztree" class="ztree"></ul></div></td></tr>
                        <tr><td><input type="hidden" name="authrityNameHidden" id="authrityNameHidden" /></td>
                        <td> <input id="btn" type="button" value="提交" class="yt-seach-btn" onclick="return addMerchantUserRole();">
                        </td></tr>
                </table>
       	</form>
    </div>
