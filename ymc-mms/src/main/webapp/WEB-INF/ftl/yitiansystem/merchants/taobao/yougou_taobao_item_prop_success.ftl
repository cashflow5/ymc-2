...
<style>
	.headstep{background:url('${BasePath}/images/importtaobaostep-new.jpg') 0px -62px;height:25px;padding-top:6px;color:#ffffff;font-weight:bold;}
	.info{background:#F2F2F2;padding:10px;margin:10px 0px;font-size:13px;}
	.tab_content a{font-size:13px;color:#4C9BC3}
</style>
</head>
<body>
<div class="container">
		<div class="normal_box">
			...
			<p style="position:absolute;top:0;right:0;">
				<div class="headstep">
					...
					<div style="float:left;width:295px;text-align:center">设置成功</div>
				</div>
				<div class="info">
				...
				<div class="tab_content" style="text-align:center"> 
					<div  style="width:360px;margin:0px auto;margin-top:100px;">
						<div style="float:left;width:50px;"><img src="${BasePath}/images/u29_normal.jpg" width="50"></div>
						<div style="float:left;width:300px;margin-left:10px;">
							<div style="text-align:left;font-size:18px;font-weight:bold">恭喜您，分类属性配置已保存成功!</div>
							<div style="text-align:left;margin-top:10px;"><a href="goYougouTaobaoItemCat.sc">返回分类对应列表</a>&nbsp;&nbsp;&nbsp;<a href="goBindCat.sc">继续进行分类设置</a></div>
						</div>
