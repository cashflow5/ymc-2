...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr">
				  <span><a href="#" class="btn-onselc">添加商家耗材信息</a></span>
				</li>
				
			</ul>
		</div>
 <div class="modify"> 
     <form action="${BasePath}/yitiansystem/merchants/businessorder/add_merchantConsumable.sc" name="queryForm" id="queryForm" method="post"  enctype="multipart/form-data">
                <table cellpadding="0" cellspacing="0" class="list_table">
                        ...
                        <input type="text" name="consumableCode" id="consumableCode"/>
                        ...
                        <tr><td>&nbsp;</td><td>
                         <input id="btn" type="button" value="提交" class="yt-seach-btn" onclick="return addMerchantConsumable();">
                        </td></tr>
                </table>
       	</form>
    </div>
