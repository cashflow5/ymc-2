...
<head>
	...
	$(function(){
		$(".list_table tr.datatr").live("click",function(){
			...
			dg.curWin.setYougouBrand(brandNo,brandName);
			closewindow();
		});
	...
	<div class="list_content">
		<div class="top clearfix">
				<ul class="tab">
					<li  class="curr">
						<span>
							<a href="#" class="btn-onselc">优购品牌</a>
						</span>
					</li>
				</ul>
		</div>
					...
					<table>
						<tr class="form-table-tr" style="height:35px;">
							...
							<td>
								...
								<input type="text" name="yougouBrandNames" style="display:none">
								<span style="color:red;padding:0px 10px;font-size:12px;">请输入品牌名牌查询</span>
							</td>
							<td>
