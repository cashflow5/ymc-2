...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr">
				  <span><a href="#" class="btn-onselc">添加商家资源信息</a></span>
				</li>
				
			</ul>
		</div>
 <div class="modify"> 
     <form action="${BasePath}/yitiansystem/merchants/businessorder/add_merchants_authority.sc" name="queryForm" id="queryForm" method="post"  enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" id="id" value="<#if id??>${id!''}</#if>"> 
                <table cellpadding="0" cellspacing="0" class="list_table">
                        <tr><td style="text-align:right">
                         ...
                         <input type="text"  name="authrityName" id="authrityName"/>
                        ...
                        <tr><td>&nbsp;</td><td>
                         <input id="btn" type="button" value="提交" class="yt-seach-btn" onclick="return add_merchantsAuthority();">
                        </td></tr>
                </table>
       	</form>
    </div>
...
<script type="text/javascript">
//添加资源信息
function add_merchantsAuthority(){
   //名称
