	...
	<div class="toolbar">
		<div class="t-content">
			<div class="btn" onclick="addMerchantYougouAdmin();">
	        	...
	        	<span class="btn_txt">添加商家业务管理员</span>
	...
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				...
				<li  class="curr">
				  <span><a href="#" class="btn-onselc">业务管理员用户列表</a></span>
				</li>
			</ul>
		</div>
 <div class="modify"> 
     <form action="${BasePath}/yitiansystem/merchants/businessorder/to_merchants_businessAdmin_list.sc" name="queryForm" id="queryForm" method="post">
  			  	<div class="wms-top">
                  	<label>管理员名称：</label>
                    	...
                    	<#list pageFinder.data as item >
	                        <tr>
		                        ...
		                        <td>
			                        ...
			                        <#if (merchantUser.isYougouAdmin)??&&merchantUser.isYougouAdmin==2>
			                         	<a href="#" onclick="toEditMerchantYougouAdmin('${item['id']!''}')">修改</a>
				                        <a href="#" onclick="assignAuthoritys('${item['id']!''}')">设置权限组</a>
...
//跳转到分配权限页面
function assignAuthoritys(id){
   openwindow("${BasePath}/yitiansystem/merchants/businessorder/distributeRole.sc?yougouAdminId="+id,600,500,"分配商家权限组");
}
//删除帐号信息
...
function addMerchantYougouAdmin(){
   openwindow("${BasePath}/yitiansystem/merchants/businessorder/toAddMerchantYougouAdmin.sc?yg_admin_type=2",360,300,"添加商家业务管理员");
}
function toEditMerchantYougouAdmin(id){
   openwindow("${BasePath}/yitiansystem/merchants/businessorder/toEditMerchantYougouAdmin.sc?yg_admin_type=2&&merchantUserId="+id,360,300,"编辑商家业务管理员");
}
