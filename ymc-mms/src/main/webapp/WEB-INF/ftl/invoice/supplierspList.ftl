...
<div class="container">
	<div class="list_content">
		...
		<div class="modify">
		<form action="${BasePath}/invoice/web/invoiceSupplierController/to_invoiceSupplier.sc" method="post" id="queryForm" name="queryForm">
		...
		<table class="list_table" cellspacing="0" cellpadding="0" border="0">
				...
				<tbody>
					<#if pageFinder??&&pageFinder.data??&&pageFinder.data?size!=0>
					    ...
					    <tr>
						  <td class="ft-cl-r" style="text-align: center;"><input type="radio" name="ra" id="ra"  onclick="return checkVlale('${item['supplierCode']!""}','${item['supplier']!""}');"></td>
