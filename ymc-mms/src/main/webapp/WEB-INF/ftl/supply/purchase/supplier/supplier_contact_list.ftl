...
//修改联系人	
function updateContact(path,contactId){
    var id=$("id").val();
    if(id!=""){
		openwindow(path+'/yitiansystem/merchants/businessorder/initial_linkmanList.sc?flag=1&id='+contactId+'&supplierSpId='+id,700,500,'编辑联系人');
	}
}
...
<!--工具栏start-->
	...
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				...
				<li>
				  <span><a href="toUpdateSupplierFinance.sc?id=${supplier.id}" class="btn-onselc">财务信息</a></span>
				</li>
				<li  class='curr'>
 ...
 <div class="blank10"></div>
				&nbsp;<a href="${BasePath}/supply/manage/supplier/toManage.sc" alt="返回供应商管理列表" style="color:red;">返回</a>	
				 ...
				 <div class="blank10"></div>	
					 <table cellpadding="0" cellspacing="0" class="list_table">
					  <tr>					  						
						...
						<td class="pl-tt-td" width="15%">操作</td>
					  </tr>	
					  <#if pageFinder??>
					  <#if pageFinder.data??>				 
					  ...
					  <tr class="div-pl-list"> 												
						...
						<td class="pl-edt">		
						<a href="javascript:updateContact('${BasePath}','${supplier.id}');">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;						
