...
var toAddUrl="${BasePath}/supply/manage/recall/c_addRecallUI.sc";
var doQueryUrl="${BasePath}/supply/manage/recall/toQueryRecallConfirm.sc";
</script>
</head> 
<body>
<div class="container"> 
	...
	<div class="toolbar">
		<div class="t-content">
			<div class="btn" onclick="javascript:toAdd()"> <span class="btn_l" ></span> <b class="ico_btn add"></b> <span class="btn_txt">新增召回确认单</span> <span class="btn_r"></span> </div>
		</div>
	</div>
	<div class="list_content"> 
		...
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"><span>召回确认单 </span></li>
			</ul>
		</div>
		<!--当前位置end-->
		<div class="modify"> 
...
<form name="pageForm" id="pageForm"	action="${BasePath}/supply/manage/recall/toQueryRecallConfirm.sc" method="POST" >
...
function doQueryDetail(id){
    window.location.href = "${BasePath}/supply/manage/recall/toSaveConfirm.sc?mainId="+id+"";
}
