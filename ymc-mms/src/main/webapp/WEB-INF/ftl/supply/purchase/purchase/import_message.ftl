...
<div class="contentMain">
        	<div class="ytback-tt-1 ytback-tt">
            	<span>您当前的位置：</span>采购管理 &gt; 采购管理 &gt; 提示信息
	</div>
                ...
                <div class="wms-div">
                	...
                	<#if result??>
	                	...
	                	<#list result as message>
							<TR>
								<TD><font color="red">${message.remark?default('')}</font></TD>
							</TR>
						</#list>
						<#else>
						导入成功!
                	...
                	<p class="blank15"></p>
                	<p><input type="button" class="wms-form-btn-2" onclick="goback('${BasePath}/supply/manage/purchase/u_updatePurchaseUI.sc?id=<#if purchaseId??>${purchaseId}</#if>');"  value="返回"   />
                	</p>
                </div>
            </div>
</div>
