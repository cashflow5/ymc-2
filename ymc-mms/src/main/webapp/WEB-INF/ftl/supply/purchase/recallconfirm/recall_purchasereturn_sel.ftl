...
<div class="container"> 
	...
	<div class="list_content"> 
		...
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"><span>召回确认-采购退库列表 </span></li>
			</ul>
		</div>
		<!--当前位置end-->
		<div class="modify"> 
			...
			<div class="add_detail_box">
				<input type="hidden" name="url" value="/supply/purchase/recallconfirm/recall_purchasereturn_sel" />
					<p>
						<span>
						  <label>供&nbsp;应&nbsp;商：</label>
...
<form name="updatAllForReturnConfirmFrom" id="updatAllForReturnConfirmFrom"	action="${BasePath}/supply/manage/recall/toSaveConfirm.sc" method="POST">
