...
<body>
<form action ="queryPurchase.sc" id="submitForm" name="submitForm" method="post">
<div class="main-body" id="main_body">	
			<div class="cont-nav ft-sz-12"><span>采购管理 &gt; 采购单&gt; 采购单明细</span></div>
			<div class="pro-list">
				...
				<div class="add-newpd ft-sz-12 fl-rt"><a href="javascript:selectCommodity('${BasePath}')" alt="向采购单添加商品">添加商品</a></div>					
				</div>
			</div>			 
			<div class="div-pl">
				<div class="div-pl-hd ft-sz-12">										
					<div class="bid-sort">					
				        采购单编号：<Strong>${purchase.purchaseCode?default("")}</Strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                	
                                                   采购类型 ：<Strong>${purchase.type?default("")}</Strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                                  供应商：<Strong>${purchase.supplier?default("")}</Strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="div-pl-hd ft-sz-12">
					...
					<input type="button" value="搜索" name="search" id="search" onClick="postForm('submitForm', '${BasePath}/supply/manage/supplier/querySupplier.sc')" class="btn-sh"/>
				</div>			
				<div class="div-pl-table" id="div-table">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr class="div-pl-tt">
					  	<td class="pl-tt-td" width="8%">采购类型</td>
					  	<td class="pl-tt-td" width="8%">货品编号</td>					  						
						<td class="pl-tt-td" width="8%">货品名称</td>													
						...
						<td class="pl-tt-td" width="36%">操作</td>
					  </tr>	
					  <#if pageFinder??>
					  <#if pageFinder.data??>				 
					  ...
					  <tr class="div-pl-list">
					  	...
					  	<#if purchaseDetail.purchaseType??>
							...
							<#elseif purchaseDetail.purchaseType==108>配折结算					
							</#if>						
						</#if>
					  	</td> 					  
						...
						<a href="javascript:deletePurchaseDetail('${purchaseDetail.id}');">删除</a>
