...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class='curr'> <span>供应商残品返回-选择供应商</span> </li>
			</ul>
		</div>
		<div class="modify">
				<!--普通搜索内容开始-->
			<div class="add_detail_box">
				<form action="${BasePath}/supply/manage/returnDefectSp/toAddReturnDefectSp.sc" method="post" id="supperAction" name="supperAction">
