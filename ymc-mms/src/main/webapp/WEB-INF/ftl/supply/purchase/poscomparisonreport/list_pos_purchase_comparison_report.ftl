...
var doQueryUrl="${BasePath}/supply/purchase/posPurchaseComparisonReport/toQueryPosPurchaseComparison.sc";
var doExportUrl="${BasePath}/supply/purchase/posPurchaseComparisonReport/doExportPosPurchaseComparison.sc"
</script>
</head> 
<body>
<div class="container"> 
	...
	<div class="list_content"> 
		...
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"><span>POS采购单对比报表 </span></li>
			</ul>
		</div>
		<!--当前位置end-->
		<div class="modify"> 
	        ...
	        <tr>
	          ...
	          <td>${item.posPurchaseCode?if_exists}</td>
	          <td>${item.ygWareHouseName?if_exists}</td>
...
<form name="pageForm" id="pageForm"	action="${BasePath}/supply/purchase/posPurchaseComparisonReport/toQueryPosPurchaseComparison.sc" method="POST" >
