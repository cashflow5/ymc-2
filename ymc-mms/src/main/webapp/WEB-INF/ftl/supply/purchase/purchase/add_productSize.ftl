...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class='curr'> <span>添加商品尺码</span> </li>
			</ul>
		</div>
		<div class="modify">
			<form action="c_addProductSize.sc" method="post" id="saveProductSizeForm" name="saveProductSizeForm"> 	
				<table class="com_modi_table">
					...
					<tr>
						...
						<td><input id="submitbutton" type="submit" class="btn-save" value="提交" style="margin-top:0px;" /></td>
						<td></td>
					</tr>
					</tbody>
				</table>
