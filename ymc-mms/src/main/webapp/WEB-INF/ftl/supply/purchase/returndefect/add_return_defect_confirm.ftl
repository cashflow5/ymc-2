...
<script type="text/javascript">
   ...
   function doSave(type) {
	...
	$(document).ready(function(){
		//$('#allocationDate').calendar({format:'yyyy-MM-dd HH:mm:ss', targetFormat:'yyyy-MM-dd HH:mm:ss',btnClear:false});
	});
...
function toAddDetail() {
	...
	var toAddDetailUrl="${BasePath}/wms/stocksmanager/purchasereturn/toPurchaseReturnSel.sc?supplierCode="+supplierCode+"&supplierName="+supplierName+"&returnDefectConfirmId="+$('#id').val()+"&queryTypeFlag=1&url=supply/purchase/returndefect/common_purchasereturn_sel";
...
<div class="container">
	...
	<div class="list_content"> 
		...
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"> <span> 新增退残确认单</span> </li>
			</ul>
		</div>
		<!--当前位置end-->
		<div class="modify">
