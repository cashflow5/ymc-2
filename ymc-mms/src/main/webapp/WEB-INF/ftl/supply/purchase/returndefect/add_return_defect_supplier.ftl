...
//选择供应商
function tosupper(){
   openwindow('${BasePath}/supply/manage/returnDefect/to_suppliersp.sc',800,500,'选择供应商',1);
}
</script>
...
<div class="container">
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class='curr'> <span>退残确认-选择供应商</span> </li>
			</ul>
		</div>
		<div class="modify">
				<!--普通搜索内容开始-->
			<div class="add_detail_box">
				<form action="${BasePath}/supply/manage/returnDefect/toAddReturnDefectConfirm.sc" method="post" id="supperAction" name="supperAction">
