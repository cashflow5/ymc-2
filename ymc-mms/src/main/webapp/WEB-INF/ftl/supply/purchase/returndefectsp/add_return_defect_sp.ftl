...
function toAddDetail() {
	...
	var toAddDetailUrl="${BasePath}/wms/stocksmanager/purchasereturn/toPurchaseReturnSel.sc?supplierCode="+supplierCode+"&supplierName="+supplierName+"&returnDefectConfirmId="+$('#id').val()+"&queryTypeFlag=1&url=supply/purchase/returndefectsp/common_purchasereturn_forspredef";
...
<div class="container">
	...
	<div class="list_content"> 
		...
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"> <span> 新增残品返回申请单</span> </li>
			</ul>
		</div>
		<!--当前位置end-->
		<div class="modify">
