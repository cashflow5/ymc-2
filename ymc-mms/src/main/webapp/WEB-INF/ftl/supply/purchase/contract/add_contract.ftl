...
<div class="container">
	...
	<div class="list_content">
		<div class="top clearfix">
			<ul class="tab">
				<li class="curr"><span>添加合同</span></li>
			</ul>
		</div>
				...
				<form id="formContract" name="formContract" action="${BasePath}/supply/manage/suppliercontract/upSaveContractFile.sc" method="POST" enctype="multipart/form-data">
					...
					<tbody>
						...
						<tr>
							...
							<td style="padding-bottom:10px;"><input type="text" id="contractNo" name="contractNo" class="validate[required]" data-rel="请输入合同编号" maxlength="50" style="width:200px;" /></td>
						...
						<tr>
							...
							<td>
							<input id="startDate" name="startDate" class="inputtxt validate[required]" type="text" style="width:120px;"  data-rel="请选择有效开始日期" readonly="readonly" size="16" value=""/>
					 		&nbsp;至&nbsp;
							<input id="endDate" name="endDate" class="inputtxt validate[required]" type="text" style="width:120px;" data-rel="请选择有效结束日期" readonly="readonly" size="16" value=""/>
		                	</td>
						</tr>
