...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	    var dd = new Date();
		var year1 = dd.getFullYear()-15;
		var year2 = parseInt(year1)+20;
	this.beginYear = beginYear || year1;
	this.endYear   = endYear   || year2;
...
var divs = [];
divs[divs.length] = '<div id="__calendarPanel" style="position:absolute;display:none;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;z-index:99999">';
