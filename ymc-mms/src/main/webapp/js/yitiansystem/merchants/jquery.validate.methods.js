...
jQuery.validator.addMethod("mobile", function(value, element) {
	...
	var telReg = !!value.match(/^1[3|4|5|7|8]\d{9}$/);
	return this.optional(element) || telReg;
}, "手机号码格式错误,请重新输入!");
...
//判断是否为英文、数字(a-zA-Z0-9)和-
jQuery.validator.addMethod("isRightForInstitutional", function(value, element) {  
	//console.log("isRightNumOrString");
     return this.optional(element) || /^[A-Za-z0-9(\-)]+$/.test(value);       
}, "只支持：英文、数字(a-zA-Z0-9)和-");   
//判断是否为英文、数字(a-zA-Z0-9)
jQuery.validator.addMethod("isRightNumOrString", function(value, element) {  
	//console.log("isRightNumOrString");
     return this.optional(element) || /^[A-Za-z0-9]+$/.test(value);       
}, "只支持：英文、数字(a-zA-Z0-9)");   
...
//判断是否1-100数字
jQuery.validator.addMethod("lessThen100Num", function(value, element) {  
	//console.log('lessThen100Num');
     var reg = RegExp(/^([0-9]|[1-9][0-9]|[1][0][0])$/);   
     return this.optional(element) || reg.test(value);       
}, "只可输入1-100之间的数字");   
