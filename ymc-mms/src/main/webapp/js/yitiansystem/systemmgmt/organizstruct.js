...
function updateOrganizStructNode(){
	...
	var url="u_updateOrganizStructNode.sc";
...
function addOrganizStructNode(){
	...
	var url="c_addOrganizStructNode.sc";
	var data={
		"orgName":newNodeText,
		"yitianInd":$("#yitianInd").val(),
		"remark":$("#remark").val(),
...
function loadNodeData(nodeid){
	var url = "queryOrganizStructById.sc";
	var data={
		"id":nodeid
	};
	...
	ajaxRequest(url,data,function(result){
		...
		$("#yitianInd").attr("value",node.attributes.yitianInd);
...
function removeOrganizStructNode(){
	...
	var url = "d_removeOrganizStructNode.sc";
	var data={
