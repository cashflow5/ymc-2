 ...
 */
function backToList(){
	window.location=basePath+"/yitiansystem/systemmgmt/systemintegral/toIntegralList.sc";
}
...
function checkName(){
	...
	//checkNameIsExist
	var url =basePath + "/yitiansystem/systemmgmt/systemintegral/checkNameIsExist.sc";
