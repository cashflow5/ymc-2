...
function addProdToTags(ids){
	 ...
	 url.push("/yitiansystem/cms/productrank/c_addProductToTags.sc");
	 $.ajax({
       type: "POST",
...
function useRecommend(tagsId){
	 ...
	 var url = [];
	 url.push($("#basePath").val());
	 url.push("/yitiansystem/cms/productrank/u_updateProductState.sc");
	 $.ajax({
       type: "POST",
...
function delRecommend(tagsId){
	 ...
	 var url = [];
	 url.push($("#basePath").val());
	 url.push("/yitiansystem/cms/productrank/d_removeProductFormTags.sc");
	 $.ajax({
       type: "POST",
       data: {"tagsId":tagsId},
       url: url.join(""),
