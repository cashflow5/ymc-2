...
function initColor(){
    ...
    colorTable='<table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px #000000 solid;border-bottom:none;border-collapse: collapse" bordercolor="000000">'
               ...
               +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href=### id="_cclose"></a></td></tr></table></td></table>'
...
function tt(obj,txtobj){
	alert('---------');
	 $('#'+obj).click(function(){
	        //��λ
	        var ttop  = $(this).offset().top;     //�ؼ��Ķ�λ���
	        var thei  = $(this).height();  //�ؼ�����ĸ�
	        var tleft = $(this).offset().left;    //�ؼ��Ķ�λ���
	        $("#colorpanel").css({
	            top:ttop+thei+5,
	            left:tleft
	        })        
...
function showColorPanel(obj,txtobj){
	alert(txtobj + '-----090-----' + obj);
	tt(obj,txtobj);
	 $('#'+obj).unbind('click');
     $('#'+obj).bind('click',tt(obj,txtobj));
//    $('#'+obj).click(function(){
//        //��λ
//        var ttop  = $(this).offset().top;     //�ؼ��Ķ�λ���
//        var thei  = $(this).height();  //�ؼ�����ĸ�
