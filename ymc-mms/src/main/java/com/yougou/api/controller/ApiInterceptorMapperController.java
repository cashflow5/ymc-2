...
public class ApiInterceptorMapperController {
	
	@Resource
	private IApiInterceptorMapperService apiInterceptorMapperService;

	@RequestMapping("/mapper/view")
	public ModelAndView viewInterceptorMapper(ApiInterceptorMapper interceptorMapper) throws Exception {
	...
	public void saveOrUpdateInterceptorMapper(ApiInterceptorMapper interceptorMapper, HttpServletResponse response) throws Exception {
		try {
	...
	public void deleteInterceptorMapper(ApiInterceptorMapper interceptorMapper, HttpServletResponse response) throws Exception {
		try {
