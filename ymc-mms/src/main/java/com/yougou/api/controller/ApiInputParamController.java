 ...
 */
@Controller
@RequestMapping("/openapimgt/api/inputparam")
public class ApiInputParamController {
	...
	public void deleteApiInputParam(ApiInputParam inputParam, HttpServletResponse response) throws Exception {
		try {
	...
	public void saveOrUpdateApiInputParam(ApiInputParam inputParam, HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
	...
	@RequestMapping("/view")
	public ModelAndView viewApiInputParam(ApiInputParam inputParam) throws Exception {
	...
	public ModelAndView viewApiInputParamMetadata(String refId, String metadataId) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		...
		if (StringUtils.isNotBlank(metadataId)) {
			...
			apiInputParam.setApi(apiService.getApiById(refId));
	...
	public void saveOrUpdateApiInputParamMetadata(ApiInputParamMetadata apiInputParamMetadata, String inputParamId, HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			...
			if (StringUtils.isBlank(apiInputParamMetadata.getId())) {
				...
				apiInputParamMetadata.setInputParam(new ApiInputParam(inputParamId));
