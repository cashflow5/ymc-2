...
public class ImageValidate2 extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8274344098241068537L;

	/**
	 * Constructor of the object.
	 */
	public ImageValidate2() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
	     ...
	     // 在内存中创建图象
	        ...
	        session.setAttribute(Constant.LOGIN_VALIDATE_IMAGE2, sRand);
	        // 图象生效
	        g.dispose();
	        // 输出图象到页面
